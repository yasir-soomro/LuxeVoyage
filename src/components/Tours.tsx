...
import { Star, Clock, MapPin, ArrowRight, X } from "lucide-react";
        ...
        {selectedTour && (
          ...
          >
            <motion.div
              ...
              className="bg-zinc-900 border border-white/10 rounded-3xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto relative"
            ...
            >
              ...
              <h2 className="text-3xl font-serif font-bold text-white mb-4">{selectedTour.title}</h2>
              <p className="text-zinc-400 mb-6">{selectedTour.description}</p>
              ...
              <div className="border-t border-white/10 pt-6">
                ...
                <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                  <input type="text" placeholder="Your Name" className="w-full bg-black border border-white/10 rounded-xl p-3 text-white" />
                  <input type="email" placeholder="Your Email" className="w-full bg-black border border-white/10 rounded-xl p-3 text-white" />
                  <Button className="w-full bg-white text-black hover:bg-white/90">Confirm Booking</Button>
                </form>
              </div>
            </motion.div>
          </motion.div>
